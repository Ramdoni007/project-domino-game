...
function() {
	...
	if (i) {
		s[(t += "_") + "constructor"] = i.constructor;
		for (var n in i) s.hasOwnProperty(n) && "function" == typeof i[n] && (s[t + n] = i[n])
	}
	return e
...
function() {
	...
	e.initialize = function(e) {
		...
		var i;
		i = s ? this._captureListeners = this._captureListeners || {} : this._listeners = this._listeners || {};
		var n = i[e];
		return n && this.removeEventListener(e, t, s), n = i[e], n ? n.push(t) : i[e] = [t], t
		...
		if (e.bubbles && this.parent) {
			...
			var r, a = n.length;
			for (r = a - 1; r >= 0 && !e.propagationStopped; r--) n[r]._dispatchEvent(e, 1 + (0 == r));
			for (r = 1; a > r && !e.propagationStopped; r++) n[r]._dispatchEvent(e, 3)
...
function() {
	...
	e.ABSOLUTE_PATT = /^(?:\w+:)?\/{2}/i, e.RELATIVE_PATT = /^[.\/]*?\//i, e.EXTENSION_PATT = /\/?[^\/]+\.(\w{1,5})$/i, e.parseURI = function(t) {
		...
		i > -1 && (t = t.substr(0, i));
		var n;
		return e.ABSOLUTE_PATT.test(t) ? s.absolute = !0 : e.RELATIVE_PATT.test(t) && (s.relative = !0), (n = t.match(e.EXTENSION_PATT)) && (s.extension = n[1].toLowerCase()), s
		...
		var i = "" != t.hostname && (t.port != s.port || t.protocol != s.protocol || t.hostname != s.hostname);
		return i
...
function() {
	...
	e.ACTIVEX_VERSIONS = ["Msxml2.XMLHTTP.6.0", "Msxml2.XMLHTTP.5.0", "Msxml2.XMLHTTP.4.0", "MSXML2.XMLHTTP.3.0", "MSXML2.XMLHTTP", "Microsoft.XMLHTTP"], t.getResult = function(e) {
		...
		var u = null;
		if (u = e.method == createjs.AbstractLoader.GET ? createjs.RequestUtils.buildPath(e.src, e.values) : e.src, n.open(e.method || createjs.AbstractLoader.GET, u, !0), t && n instanceof XMLHttpRequest && 1 == this._xhrLevel && (i.Origin = location.origin), e.values && e.method == createjs.AbstractLoader.POST && (i["Content-Type"] = "application/x-www-form-urlencoded"), t || i["X-Requested-With"] || (i["X-Requested-With"] = "XMLHttpRequest"), e.headers)
			for (var c in e.headers) i[c] = e.headers[c];
	...
	s.INTERRUPT_ANY = "any", s.INTERRUPT_EARLY = "early", s.INTERRUPT_LATE = "late", s.INTERRUPT_NONE = "none", s.PLAY_INITED = "playInited", s.PLAY_SUCCEEDED = "playSucceeded", s.PLAY_INTERRUPTED = "playInterrupted", s.PLAY_FINISHED = "playFinished", s.PLAY_FAILED = "playFailed", s.SUPPORTED_EXTENSIONS = ["mp3", "ogg", "mpeg", "wav", "m4a", "mp4", "aiff", "wma", "mid"], s.EXTENSION_MAP = {
		...
		if (s._preloadHash[t])
			for (var i = 0, n = s._preloadHash[t].length; n > i; i++) {
				...
				if (s._preloadHash[t][i] = !0, s.hasEventListener("fileload")) {
					var e = new createjs.Event("fileload");
					e.src = r.src, e.id = r.id, e.data = r.data, e.sprite = r.sprite, s.dispatchEvent(e)
				}
			}
		...
		if (s._preloadHash[t])
			for (var i = 0, n = s._preloadHash[t].length; n > i; i++) {
				var r = s._preloadHash[t][i];
				if (s._preloadHash[t][i] = !1, s.hasEventListener("fileerror")) {
		...
		if (null == n) return !1;
		e = n.src;
		for (var r in s._idHash) s._idHash[r].src == e && delete s._idHash[r];
		...
		var l = s.createInstance(e, u, c),
			h = s._playInstance(l, t, i, n, r, a, o);
		...
		if (t instanceof Object && (i = t.delay, n = t.offset, r = t.loop, a = t.volume, o = t.pan, t = t.interrupt), t = t || s.defaultInterruptBehavior, null == i && (i = 0), null == n && (n = e.getPosition()), null == r && (r = e.loop), null == a && (a = e.volume), null == o && (o = e.pan), 0 == i) {
			var u = s._beginPlaying(e, t, n, r, a, o);
			if (!u) return !1
		} else {
		...
		var o = e._beginPlaying(i, n, r, a);
		if (!o) {
			var u = createjs.indexOf(this._instances, e);
		...
		var i = t.get(e);
		return null == i && (t.channels[e] = new t(e, s), !0)
...
function() {
	...
	var e = function(e, t, s, i) {
			...
			}), i !== !1 && i !== !0 && this.setPlaybackResource(i), this._position = 0, createjs.definePropertySupported && Object.defineProperty(this, "position", {
	...
	e._capabilities = null, e.isSupported = function() {
		...
		if (this._soundInstances[e]) {
			for (var t = this._soundInstances[e].length; t--;) {
				var s = this._soundInstances[e][t];
				s.destroy()
			}
		...
		for (var s = 0, i = this._soundInstances[t].length; i > s; s++) {
			var n = this._soundInstances[t][s];
